...
albedo_pred = 0.0473 + 0.8119*Rs_VN01 + 0.3791*Rs_VN02 + -0.5288*Rs_VN03 
            + 0.1615*Rs_VN05 + -1.5862*Rs_VN07 + 1.3364*Rs_VN08 
            + 0.0339*Rs_VN09 + 0.6624*Rs_VN10 + -0.4818*Rs_VN11 + 0.3552*Rs_SW03
