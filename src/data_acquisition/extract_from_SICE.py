...
csv_output_path = '/data_3/shunan_2/AU/hsa500m/SICE/albedo_sice.csv'
...
for year in years:
    ...
    for i in range(len(sice_files_year)):
        ...
        try:
            ...
            grid_indices = []
            for x_aws, y_aws in zip(df_aws_year['x_proj'], df_aws_year['y_proj']):
            ...
            for y_idx, x_idx in grid_indices:
                # Extract albedo at this grid point
            ...
            df_sice['albedo_sice'] = albedo_array
            # append to csv file
